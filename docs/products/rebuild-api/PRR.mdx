...
export function createData(action, completed, date, signoff, evidence) {
...
export const rows6 = [
    ...
    createData(<p style={styles.indent0}>6.1.1. Training Session</p>),
    createData(<p style={styles.indent0}>6.1.2. QA Session</p>),
    createData(<p style={styles.indent0}>6.1.3. Approval / Feedback Session</p>),
...
[Google Python Style Guide Reference](https://google.github.io/styleguide/pyguide.html)
...
[Reference1](https://www.youtube.com/watch?v=tIfqpM3o55s)

[Reference Deployment of Serverless Applications Gradually](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/automating-updates-to-serverless-apps.html)

[Reference2](https://medium.com/@tarekbecker/a-production-grade-ci-cd-pipeline-for-serverless-applications-888668bcfe04)
...
| Customers | - | 3 |
|  |  |  |
| Overall Production Compliance |  | 66 |